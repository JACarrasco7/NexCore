...
export const tooManyRequests = (message = 'Too many requests') => errorJson({ error: message }, 429)

export const serverError = (message = 'Internal server error') => errorJson({ error: message }, 500)

export const unsupportedMediaType = (message = 'Unsupported Media Type') =>
  errorJson({ error: message }, 415)

export const payloadTooLarge = (message = 'Payload Too Large') => errorJson({ error: message }, 413)
