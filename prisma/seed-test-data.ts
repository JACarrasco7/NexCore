...
const ATHLETE_PROFILES: Record<string, {
  startWeight: number; bfPct: number; waist: number; hip: number;
  chest: number; arm: number; quad: number; calf: number; glutes: number; neck: number;
}> = {
  "Marco Ruiz":   { startWeight: 82, bfPct: 18,  waist: 85,  hip: 96,  chest: 100, arm: 36, quad: 58, calf: 39, glutes: 98,  neck: 40 },
  "Sara Leal":    { startWeight: 64, bfPct: 24,  waist: 72,  hip: 95,  chest: 88,  arm: 29, quad: 52, calf: 36, glutes: 100, neck: 33 },
  "David Molina": { startWeight: 90, bfPct: 22,  waist: 92,  hip: 102, chest: 108, arm: 40, quad: 62, calf: 42, glutes: 104, neck: 43 },
  "Ana Torres":   { startWeight: 58, bfPct: 26,  waist: 68,  hip: 92,  chest: 84,  arm: 27, quad: 50, calf: 35, glutes: 97,  neck: 31 },
};
...
async function seedAthlete(
  ...
  if (existingSessions < 8 && sessionIds.length > 0) {
    const sessionLogs: Array<{
      athleteId: string; planId: string; sessionId: string; sessionName: string;
      date: Date; durationMin: number; kcalBurned: number; heartRateAvg: number; source: string;
    }> = [];
    const setLogsMap: Map<number, Array<{
      exerciseIndex: number; exercise: string; setNumber: number;
  ...
  // ── 6. Plan Nutricional ──────────────────────────────────────────────────
  const existingNutrition = await prisma.nutritionPlan.count({ where: { athleteId, deletedAt: null } });
          ...
          create: [
            {
              ...
              foods: {
                create: [
                  { food: "Avena", quantity: 80, unit: "g", kcal: 300, proteinG: 10, carbsG: 52, fatG: 6, order: 0 },
                  { food: "Claras de huevo", quantity: 200, unit: "ml", kcal: 104, proteinG: 22, carbsG: 0, fatG: 0, order: 1 },
                  { food: "Plátano", quantity: 120, unit: "g", kcal: 107, proteinG: 1, carbsG: 27, fatG: 0, order: 2 },
                ],
              },
            },
            {
              ...
              foods: {
                create: [
                  { food: "Pechuga de pollo cocida", quantity: 150, unit: "g", kcal: 165, proteinG: 36, carbsG: 0, fatG: 3, order: 0 },
                  { food: "Arroz blanco cocido", quantity: 150, unit: "g", kcal: 195, proteinG: 4, carbsG: 43, fatG: 0, order: 1 },
                ],
              },
            },
            {
              ...
              foods: {
                create: [
                  { food: "Salmón", quantity: 200, unit: "g", kcal: 416, proteinG: 40, carbsG: 0, fatG: 28, order: 0 },
                  { food: "Patata cocida", quantity: 200, unit: "g", kcal: 160, proteinG: 4, carbsG: 37, fatG: 0, order: 1 },
                  { food: "Brócoli", quantity: 150, unit: "g", kcal: 51, proteinG: 4, carbsG: 10, fatG: 0, order: 2 },
                  { food: "AOVE", quantity: 15, unit: "ml", kcal: 135, proteinG: 0, carbsG: 0, fatG: 15, order: 3 },
                ],
              },
            },
            {
              ...
              foods: {
                create: [
                  { food: "Whey protein", quantity: 35, unit: "g", kcal: 130, proteinG: 26, carbsG: 5, fatG: 2, order: 0 },
                  { food: "Plátano", quantity: 100, unit: "g", kcal: 89, proteinG: 1, carbsG: 23, fatG: 0, order: 1 },
                ],
              },
            },
            {
              ...
              foods: {
                create: [
                  { food: "Pechuga de pollo", quantity: 200, unit: "g", kcal: 220, proteinG: 48, carbsG: 0, fatG: 4, order: 0 },
                  { food: "Pasta integral cocida", quantity: 120, unit: "g", kcal: 168, proteinG: 7, carbsG: 33, fatG: 2, order: 1 },
                  { food: "Queso cottage", quantity: 100, unit: "g", kcal: 98, proteinG: 11, carbsG: 4, fatG: 4, order: 2 },
                ],
              },
            },
          ],
  ...
  if (existingNutritionLogs < 10) {
    ...
    const logsData: Array<{
      athleteId: string; mealName: string; kcal: number;
      proteinG: number; carbsG: number; fatG: number; loggedAt: Date;
    }> = [];
