...
async function main() {
  ...
  const team = await prisma.team.create({
    data: {
      name: "Apex Coach OS",
      slug: "apex-coach",
      contractTemplate: "# Contrato Legal\n\nEste documento constituye un acuerdo vinculante entre Apex Coach y el atleta registrado.",
      settings: {
        create: {
          displayName: "Apex Coach",
          locale: "es-ES",
...
ƒöæ Credenciales:
   ...
   Atleta:  marco@apexcoach.app  /  Atleta123
   Atleta:  sara@apexcoach.app   /  Atleta123
   Atleta:  david@apexcoach.app  /  Atleta123
   Atleta:  ana@apexcoach.app    /  Atleta123
  `);
}
